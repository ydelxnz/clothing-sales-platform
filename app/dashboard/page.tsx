      ...
      <div className="flex-1 space-y-4 p-8 pt-6">
        ...
        <Tabs defaultValue="overview" className="space-y-4">
          <TabsList>
            ...
            <TabsTrigger value="analytics">详细分析</TabsTrigger>
          ...
          <TabsContent value="analytics" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>详细销售分析</CardTitle>
                <CardDescription>深入分析销售数据，发现潜在趋势和机会</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[400px] flex items-center justify-center border rounded-md">
                  <p className="text-muted-foreground">详细分析模块内容将在此显示</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
          <TabsContent value="reports" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>生成和下载各类销售报表</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[400px] flex items-center justify-center border rounded-md">
                  <p className="text-muted-foreground">报表模块内容将在此显示</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
